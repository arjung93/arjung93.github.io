...
Skills
======
* **Technical Skills**: Econometric Models, Statistics, Machine Learning, Causal Inference (A/B Testing), Artificial Intelligence, Large Language Models, Data wrangling and visualization
* **Programming Languages**: R, Matlab, Python, SQL, LaTeX, Linux, Git

Work Experience
======
* **World Bank** (Remote)
  * *Short Term Consultant* (August 2024 – Present)
  * Conducting meta-analysis for the Equitable Growth, Finance, and Institutions (EFI) Global Practice.
  * Created a Database of government interventions to improve business conditions in developing countries.
  * Conducted a literature review on the use of satellite imagery data to check the effect of Special Economic Zones in India.

* **Erasmus School of Economics and Tinbergen Institute** (Rotterdam, The Netherlands)
  * *Ph.D. Candidate in Econometrics* (September 2022 – March 2024)
...
* **National Institute of Public Finance and Policy** (New Delhi, India)
  ...
  * PenCalc: Created an R package to simulate pension distribution.
  * Assisted Ministry of Finance with presentations to credit rating agencies (S&P, Fitch, Moody's).
